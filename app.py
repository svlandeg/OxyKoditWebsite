...
def grid():
    ...
    if request.method == 'POST':
        ...
        show_static = request.form.get('show_static', 'No')
    else:
        color_list = ["0"] * img_nr
    ...
    if allow_training and to_retrain == "Yes" and show_static == "No":
...
def _get_bg_color(tufa_pred_float):
    ...
    # more red if it's not a tufa, more green if it's a tufa
